    ...
    wx.request({
      ...
      success: function(res) {
        ...
        if (code == 100) {
          ...
          userCenterDataArray[0].msgCount = result.order_number >= 100 ? "+" + 99 : result.order_number
          userCenterDataArray[1].msgCount = result.system_user_number >= 100 ? "+" + 99 : result.system_user_number
          that.setData({
